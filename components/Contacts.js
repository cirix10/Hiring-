                    ...
                    <div className="row">
                        <div className="col-lg-3">
                            <div className="contact_info_item">
                                ...
                                <p className="f_400 f_size_15">abc country </p>
                            </div>
                            <div className="contact_info_item">
                                ...
                                <p className="f_400 f_size_15"><span className="f_400 t_color3">Email:</span> <a href="mailto:recruitmentoffice@gmail.com">recruitmentoffice@gmail.com</a></p>
                            </div>
                        </div>
