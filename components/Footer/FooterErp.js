                                    ...
                                    <Reveal effect="fadeInLeft" duration={500} key={1}>
                                        <div className="col-lg-6 col-sm-6" >
                                            <div className="f_widget dark_widget company_widget" data-wow-delay="0.2s">
                                                {/* <a href="index.html" className="f-logo"><img style={{width:"150px",height:"100px",objectFit:"contain"}} src={require ("../../img/
                                                nature-logo.png")} alt=""/></a> */}

                                                <h1>Logo1</h1>

                                                <p>© 2022 Recruitment, LLC. All rights reserved. Proudly made by the Recruitment team with love.</p>
